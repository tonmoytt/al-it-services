...
const Bg = () => {
    ...
    const bgImages = [
        ...
        "https://i.ibb.co.com/d4TDyJFj/benner3.png",
        "https://i.ibb.co.com/PvH83qps/bg14.png"
    ];

    return (
        <div>
            <div className="relative mb-1 md:mb-16 ">
                ...
                <Swiper
                    ...
                    className="hero min-h-[40vh] md:h-[670px] relative"
                >
                            ...
                            >
                                ...
                                <div className="relative z-10 text-neutral-content px-4 sm:px-6 lg:px-12 w-full h-full flex items-center">
                                    <div className="flex flex-col md:flex-row items-center md:justify-between w-full gap-8">
                                        ...
                                        {/* Left Text Info */}
                                        <div className="py-6 px-6 md:px-10 shadow-md flex-1 max-w-2xl text-center md:text-left md:ml-36">
                                        ...
                                        {/* Right Video */}
                                            ...
                                            <div className=" flex-1 flex md:ml-[215px] px-6 py-2 mx-auto ">
                                                <div className="hidden md:block w-full max-w-[620px] aspect-video rounded-md overflow-hidden  border-2 border-white/30 shadow-2xl shadow-cyan-300 ">
                                                    <video
                                                        className="w-full h-full  px-4 py-2    object-cover"
                                                        src={intro}
